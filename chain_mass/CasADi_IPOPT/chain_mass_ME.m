...
odeFun = Function('odeFun',{dae.x,dae.p},{dae.ode,jacobian(dae.ode,[dae.x;dae.p])});
...
save(['../data_' num2str(Nm) '.mat'],'x0_init','xN_term');

x0 = [repmat([x0_guess;repmat(x0_guess,Ns*d,1);u_guess],N,1);x0_guess];
